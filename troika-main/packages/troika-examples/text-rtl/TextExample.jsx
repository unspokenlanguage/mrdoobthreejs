...
const TEXTS = {
  ...
  'Bidi 2': `إن أعلى المقذوفات المعروفة قبل اكتشاف الصواريخ في عقد الأربعينيات كانت تسمى قذائف من بندقية باريس، وهي نوع من القاذفات الألمانية الطويلة المدى وتسمى بندقية الحصار، والتي وصلت قذائفها إلى ارتفاع 40 كيلومترا على الأقل خلال الحرب العالمية الأولى.

واتخذ العلماء الألمان بعض الخطوات خلال فترة الحرب العالمية الثانية إذ وضعوا جسم من صنع الإنسان في الفضاء أثناء اختبار الصاروخ في - 2 V-2 الذي أصبح أول جسم من صنع الإنسان في الفضاء الخارجي رفع بتاريخ 3 أكتوبر 1942 مع إطلاق الطائرة أيه - 4 A-4.

بعد انتهاء الحرب استعملت الولايات المتحدة ما تبقى من العلماء الألمان وصواريخهم التي استولي عليها في برامج للبحوث العسكرية والمدنية. وكان أول استكشاف علمي من الفضاء هو تجربة الإشعاع الكوني التي شنتها الولايات المتحدة على صاروخ V-2 في 10 أيار / مايو 1946.
اتبع ذلك الصور الأولى مأخوذة للأرض من الفضاء في نفس العام.
أول رحلات مدارية
...
أما البعثة الثانية فكانت المركبة سبوتنيك 2، إذ أطلقها الاتحاد السوفييتي في 3 نوفمبر 1957، وحملت الكلب لايكا، الذي أصبح أول حيوان يدور في المدار خارج الغلاف الجوي.
...
أطلقت الولايات المتحدة لأول مرة شخصاً في الفضاء في غضون شهر من فوستوك 1 مع رحلة ألان شيبارد، كانت الرحلة تحت المدارية على متن ميركوري-ريدستون 3 أو الحرية 7. وحققت الولايات المتحدة الرحلة المدارية عندما صعد جون جلين على متن السفينة الصداقة 7 في 20 شباط / فبراير 1962.
          ...
          objects={ [
            ...
            } : null,
            {
              ...
              items: [
                ...
                {type: 'select', path: 'direction', options: ['auto', 'ltr', 'rtl']},
